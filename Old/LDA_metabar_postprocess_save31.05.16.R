...
existingresult = 1
# Existing LDA decomposition stored on the Genotoul cluster:
cluster = 0
...
true_KL_documents_baseline = 10^-4
...
# Comparing topics to chemistery and lidar data
abiotic_variables = 0
...
if (bij) {
  bij_insert = "bijective_correspondences"
} else if (!bij)
  bij_insert = "non-bijective_correspondences"
...
#data2m = matrix(nrow=nrow(data2m),ncol=ncol(data2m))
...
#     {
#       data2m[i,j] = as.numeric(data2m[i,j])
#       count2[i]=data2m[i,j]+count2[i]
#     }  
#   }
count2 = rowSums(data2m)
if (length(which(count2==0)) != 0)
{
...
} else if (data_pp || data_betadiv || data_betadiv_pooled)
{
  if (filled)
  {
...
if (mpar)
{
  ...
  if (mnb_topics)
  {
    if (Rtopicmodels_Gibbs) {
      local_subdirname = paste(local_dirname,filename_insert,"_",alpha_insert,"_delta",delta,"_nb_topics",nb_topics_range[1],"-",nb_topics_range[length(nb_topics_range)],"_nb_iter",nb_iter,"_nb_real",nb_real,"/",sep="")
      cluster_subdirname = paste(cluster_dirname,filename_insert,"_",alpha_insert,"_delta",delta,"_nb_topics",nb_topics_range[1],"-",nb_topics_range[length(nb_topics_range)],"_nb_iter",nb_iter,"_nb_real",nb_real,"/",sep="")
      ...
      local_subdirname = paste(local_dirname,filename_insert,"_",alpha_insert,"_nb_topics",nb_topics_range[1],"-",nb_topics_range[length(nb_topics_range)],"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,"/",sep="")
      cluster_subdirname = paste(cluster_dirname,filename_insert,"_",alpha_insert,"_nb_topics",nb_topics_range[1],"-",nb_topics_range[length(nb_topics_range)],"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,"/",sep="")
      filename = paste(filename_insert,"_",alpha_insert,"_nb_topics",nb_topics_range[1],"-",nb_topics_range[length(nb_topics_range)],"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,".Rdata",sep="")
    }
  ...
  if (!mpar)
  {
    ...
    if (Rtopicmodels_Gibbs || Rtopicmodels_VEM)
    {
      ...
      } else if (best || best_keep)
      {
        ...
        {
          if (Rtopicmodels_Gibbs) {
            local_subdirname = paste(local_dirname,filename_insert,"_alpha",alpha,"_delta",delta,"_nb_topics",nb_topics,"_nb_iter",nb_iter,"_nb_real",nb_real,"_best/",sep="")
            cluster_subdirname = paste(cluster_dirname,filename_insert,"_alpha",alpha,"_delta",delta,"_nb_topics",nb_topics,"_nb_iter",nb_iter,"_nb_real",nb_real,"_best/",sep="")
            ...
            local_subdirname = paste(local_dirname,filename_insert,"_nb_topics",nb_topics,"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,"_best/",sep="")
            cluster_subdirname = paste(cluster_dirname,filename_insert,"_nb_topics",nb_topics,"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,"_best/",sep="")
        ...
        {
          if (Rtopicmodels_Gibbs) {
            local_subdirname = paste(local_dirname,filename_insert,"_alpha",alpha,"_delta",delta,"_topics",nb_topics,"_nb_iter",nb_iter,"_nb_real",nb_real,"_best_keep/",sep="")
            cluster_subdirname = paste(cluster_dirname,filename_insert,"_alpha",alpha,"_delta",delta,"_topics",nb_topics,"_nb_iter",nb_iter,"_nb_real",nb_real,"_best_keep/",sep="")
            ...
            cluster_subdirname = paste(cluster_dirname,filename_insert,"_nb_topics",nb_topics,"_nb_real",nb_real,"_em_tol",em_tol,"_var_tol",var_tol,"_best_keep/",sep="")
    ...
    {
      local_subdirname = paste(local_dirname,filename_insert,"hdp-faster_alpha",alpha,"_gamma",gamma,"_eta",eta,"_maxiter",maxiter,"_norep",sep="")
      if (!(file.exists(local_subdirname)))
        dir.create(local_subdirname)
      setwd(local_subdirname) 
...
{ 
  ...
  {
    KL_MOTUwise = vector(mode="list",length=length_selected_real-1)
    KL_samplewise = vector(mode="list",length=length_selected_real-1)
    DKL100_samplewise = vector(mode="list",length=length_selected_real-1)
    Correlation_MOTUwise = vector(mode="list",length=length_selected_real-1)
    ...
    KL_MOTUwise_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    KL_samplewise_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    KL_samplewise_allRealPairs[lower.tri(KL_samplewise_allRealPairs,diag=T)] = NA
    KL_samplewise_allRealPairs_byTopic = list()
    for (k in 1:nb_topics)
      KL_samplewise_allRealPairs_byTopic[[k]] = matrix(nrow=length_selected_real,ncol=length_selected_real,data=NA)
    ...
    KL_samplewise_allRealPairs_w_rndzations = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    diag(KL_samplewise_allRealPairs_w_rndzations) = NA
    
    DKL100_samplewise_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    DKL100_samplewise_allRealPairs[lower.tri(DKL100_samplewise_allRealPairs,diag=T)] = NA
    DKL100_samplewise_allRealPairs_byTopic = list()
    for (k in 1:nb_topics)
      DKL100_samplewise_allRealPairs_byTopic[[k]] = matrix(nrow=length_selected_real,ncol=length_selected_real,data=NA)
    
    Var_KL_samplewise_topic_comparison_randomized_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    Var_KL_samplewise_topic_comparison_randomized_allRealPairs[lower.tri(Var_KL_samplewise_topic_comparison_randomized_allRealPairs,diag=T)] = NA
    Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic = list()
    for (k in 1:nb_topics)
      Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic[[k]] = matrix(nrow=length_selected_real,ncol=length_selected_real,data=NA)
    ...
    Correlation_MOTUwise_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    Correlation_samplewise_allRealPairs = matrix(nrow=length_selected_real,ncol=length_selected_real,data=0)
    Correlation_MOTUwise_allRealPairs_byTopic = list()
    Correlation_samplewise_allRealPairs_byTopic = list()
    for (k in 1:nb_topics)
    {
      Correlation_MOTUwise_allRealPairs_byTopic[[k]] = matrix(nrow=length_selected_real,ncol=length_selected_real,data=NA)
      Correlation_samplewise_allRealPairs_byTopic[[k]] = matrix(nrow=length_selected_real,ncol=length_selected_real,data=NA)
    }
  ...
  for (j_select in 1:length_selected_real)
  {
    ...
    if (realization_comparison)
    {
      ...
      topic_compo_allreal[[j_select]] = matrix(nrow=nb_terms,ncol=nb_topics,data=0)
      for (k in 1:nb_topics)
    ...
    if ((j_select != 1) && realization_comparison)
    {
      ...
      # -> Redundant with Correlation_samplewise up to the ordering of the topics, but used for testdata=1
      Correlation[[j_select-1]] = cor(documents_allreal[[1]],documents)
      ...
      for (j_real in 1:(j_select-1))
      {
        ...
        for (k in 1:nb_topics)
        {
          ...
          {
            #KL_MOTUwise_topic_comparison[k,k1] = 1/2*1/nb_topics*(KL.plugin(topic_compo_allreal[[j_real]][,k],topic_compo_allreal[[j_select]][,k1]) +
            #KL.plugin(topic_compo_allreal[[j_select]][,k1],topic_compo_allreal[[j_real]][,k]))
            KL_samplewise_topic_comparison[k,k1] = 1/2*(KL.plugin(KL_documents_allreal[[j_real]][,k],KL_documents_allreal[[j_select]][,k1]) +
        ...
        Mean_KL_samplewise_topic_comparison_randomized = vector(length=nb_topics,mode="numeric")
        p_value = 0
        ...
        if (bij)
        {
          ...
          sorted_KL_samplewise_topic_comparison = sort.int(KL_samplewise_topic_comparison,index.return=T)
          while (nb_topics_assigned < nb_topics)
          {
            k = sorted_KL_samplewise_topic_comparison$ix[i] %% nb_topics 
            k1 = sorted_KL_samplewise_topic_comparison$ix[i] %/% nb_topics
            if (k==0)
              k = nb_topics
            else 
              k1 = k1 + 1
            ...
            {
              Topic_correspondence_samplewise[k] = k1
        ...
        {
          Topic_correspondence_samplewise = matrix(nrow=nb_topics,ncol=2,data=NA)
          sorted_KL_samplewise_topic_comparison = sort.int(KL_samplewise_topic_comparison,index.return=T)
          for (i in 1:nb_topics)
          {
            ...
            if (k==0)
              ...
              k1 = k1 + 1
            Topic_correspondence_samplewise[i,1] = k
            Topic_correspondence_samplewise[i,2] = k1
          }
        }
        ...
        if (bij)
        {
          ...
          {          
            ...
            Var_KL_samplewise_topic_comparison_randomized = 0
            for (rndzation in 1:nb_rndzations) 
            {
              KL_samplewise_topic_comparison_randomized = 1/2*(KL.plugin(KL_documents_allreal[[j_real]][,k],KL_documents_jselect_randomized[[rndzation]][,Topic_correspondence_samplewise[k]]) +
                                                                 KL.plugin(KL_documents_jselect_randomized[[rndzation]][,Topic_correspondence_samplewise[k]],KL_documents_allreal[[j_real]][,k]))
              if (KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]] > KL_samplewise_topic_comparison_randomized)
                nb_non_significant_rndzations = nb_non_significant_rndzations + 1
              Mean_KL_samplewise_topic_comparison_randomized[k] = 1/nb_rndzations*KL_samplewise_topic_comparison_randomized +
                Mean_KL_samplewise_topic_comparison_randomized[k]
              Var_KL_samplewise_topic_comparison_randomized = KL_samplewise_topic_comparison_randomized^2/nb_rndzations + 
                Var_KL_samplewise_topic_comparison_randomized
            }
            ...
            Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic[[k]][j_real,j_select] = Var_KL_samplewise_topic_comparison_randomized
            Var_KL_samplewise_topic_comparison_randomized_allRealPairs[j_real,j_select] = Var_KL_samplewise_topic_comparison_randomized/nb_topics + 
              Var_KL_samplewise_topic_comparison_randomized_allRealPairs[j_real,j_select]
        ...
        } else if (!bij)
        {
          ...
          for (i in 1:nb_topics)
          {
            k = Topic_correspondence_samplewise[i,1]
            k1 = Topic_correspondence_samplewise[i,2]
            nb_non_significant_rndzations = 0
            Var_KL_samplewise_topic_comparison_randomized = 0
            for (rndzation in 1:nb_rndzations) 
            {
              KL_samplewise_topic_comparison_randomized = 1/2*(KL.plugin(KL_documents_allreal[[j_real]][,k],KL_documents_jselect_randomized[[rndzation]][,k1]) +
                                                                 KL.plugin(KL_documents_jselect_randomized[[rndzation]][,k1],KL_documents_allreal[[j_real]][,k]))
              if (KL_samplewise_topic_comparison[k,k1] > KL_samplewise_topic_comparison_randomized)
                nb_non_significant_rndzations = nb_non_significant_rndzations + 1
              Mean_KL_samplewise_topic_comparison_randomized[i] = 1/nb_rndzations*KL_samplewise_topic_comparison_randomized +
                Mean_KL_samplewise_topic_comparison_randomized[i]
              Var_KL_samplewise_topic_comparison_randomized = KL_samplewise_topic_comparison_randomized^2/nb_rndzations + 
                Var_KL_samplewise_topic_comparison_randomized
            }
            # The value of k indexes the topics of j_real in their original order
            ...
            Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic[[i]][j_real,j_select] = Var_KL_samplewise_topic_comparison_randomized
            Var_KL_samplewise_topic_comparison_randomized_allRealPairs[j_real,j_select] = Var_KL_samplewise_topic_comparison_randomized/nb_topics + 
              Var_KL_samplewise_topic_comparison_randomized_allRealPairs[j_real,j_select]
            p_value = nb_non_significant_rndzations/nb_rndzations/nb_topics + p_value
          }
        ...
        if (j_real == 1)
        {
          Topic_correspondence_samplewise_to_best_real[[j_select]] = Topic_correspondence_samplewise
          
          #KL_MOTUwise[[j_select-1]] = KL_MOTUwise_topic_comparison[,Topic_correspondence_MOTUwise]
          KL_samplewise[[j_select-1]] = KL_samplewise_topic_comparison[,Topic_correspondence_samplewise]
          # Correlation_MOTUwise is computed using the topic correspondence obtained using the samplewise SKL as of currently
          Correlation_MOTUwise[[j_select-1]] = cor(topic_compo_allreal[[1]],topic_compo_allreal[[j_select]][,Topic_correspondence_samplewise])
          Correlation_samplewise[[j_select-1]] = cor(documents_allreal[[1]],documents_allreal[[j_select]][,Topic_correspondence_samplewise])
          DKL100_samplewise[[j_select-1]] = vector(length=nb_topics)
          for (k in 1:nb_topics)
            DKL100_samplewise[[j_select-1]][k] = Mean_KL_samplewise_topic_comparison_randomized[k] - KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]]
        }
        ...
        for (k in 1:nb_topics)
        {
          ...
          KL_samplewise_allRealPairs[j_real,j_select] = KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]]/nb_topics + KL_samplewise_allRealPairs[j_real,j_select]
          KL_samplewise_allRealPairs_byTopic[[k]][j_real,j_select] = KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]]
          
          KL_samplewise_allRealPairs_w_rndzations[j_real,j_select] = KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]]/nb_topics + KL_samplewise_allRealPairs_w_rndzations[j_real,j_select]
          KL_samplewise_allRealPairs_w_rndzations[j_select,j_real] = Mean_KL_samplewise_topic_comparison_randomized[k]/nb_topics + KL_samplewise_allRealPairs_w_rndzations[j_select,j_real]
          
          DKL100_samplewise_allRealPairs[j_real,j_select] = (Mean_KL_samplewise_topic_comparison_randomized[k] - KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]])/nb_topics + 
            DKL100_samplewise_allRealPairs[j_real,j_select]
          DKL100_samplewise_allRealPairs_byTopic[[k]][j_real,j_select] = 
            Mean_KL_samplewise_topic_comparison_randomized[k] - KL_samplewise_topic_comparison[k,Topic_correspondence_samplewise[k]]
          ...
          Correlation_MOTUwise_allRealPairs[j_real,j_select] = cor(topic_compo_allreal[[j_real]],topic_compo_allreal[[j_select]][,Topic_correspondence_samplewise])[k,k]/nb_topics +
            Correlation_MOTUwise_allRealPairs[j_real,j_select]
          Correlation_samplewise_allRealPairs[j_real,j_select] = cor(documents_allreal[[j_real]],documents_allreal[[j_select]][,Topic_correspondence_samplewise])[k,k]/nb_topics +
            Correlation_samplewise_allRealPairs[j_real,j_select]
          Correlation_MOTUwise_allRealPairs_byTopic[[k]][j_real,j_select] = 
            cor(topic_compo_allreal[[j_real]],topic_compo_allreal[[j_select]][,Topic_correspondence_samplewise])[k,k]
          Correlation_samplewise_allRealPairs_byTopic[[k]][j_real,j_select] = 
            cor(documents_allreal[[j_real]],documents_allreal[[j_select]][,Topic_correspondence_samplewise])[k,k]
        }
    ...
    if ((j_select == 1) && data_pp && !testdata && abiotic_variables)
    {
      ...
      if (filled && !filled_with_gaps)
      {
        Correlation_lidar = vector(mode = "list",length = 4)
        Correlation_lidar[[1]] = matrix(nrow = nb_topics, ncol = 11)
        Correlation_lidar[[2]] = matrix(nrow = nb_topics, ncol = 11)
        Correlation_lidar[[3]] = matrix(nrow = nb_topics, ncol = 11)
        Correlation_lidar[[4]] = matrix(nrow = nb_topics, ncol = 11)
      } else
      {
        Correlation_lidar = vector(mode = "list",length = 2)
        Correlation_lidar[[1]] = matrix(nrow = nb_topics, ncol = 11)
        Correlation_lidar[[2]] = matrix(nrow = nb_topics, ncol = 11)
      }
      
      Mean_cor_abiotic_comparison_randomized = matrix(nrow=nb_topics,ncol=11,data=0)
      Var_cor_abiotic_comparison_randomized = matrix(nrow=nb_topics,ncol=11,data=0)
      p_value_abiotic = matrix(nrow=nb_topics,ncol=11,data=0)
      
      for (j_abiotic in 1:11)
      {
        if (j_abiotic == 1)
        {
          if (filled && !filled_with_gaps)
        ...
        {
          if (filled && !filled_with_gaps)
            Cor_test = cor.test(documents[,k],data_lidarm_num[,j_abiotic])
          else if (!filled || filled_with_gaps)
            Cor_test = cor.test(documents[,k],data_lidarm_minusMissingSamples_num[,j_abiotic])
          ...
          {
            if (filled && !filled_with_gaps)
              cor_abiotic_comparison_randomized = cor(documents_randomized[[rndzation]][,k],data_lidarm_num[,j_abiotic])
            else if (!filled || filled_with_gaps)
              cor_abiotic_comparison_randomized = cor(documents_randomized[[rndzation]][,k],data_lidarm_minusMissingSamples_num[,j_abiotic])
    ...
    } else if (best || best_keep)
    {
      ...
      if (best && local) 
      {
        if (Rtopicmodels_Gibbs)
        {
          save(Result,alpha,delta,logbeta,documents,nb_doc,nb_terms,nb_topics,nb_real,nb_iter,llh_keep,llh,
               topic_compo,sort_normal_topic,KL_documents,documents,file=filename)
        } else if (Rtopicmodels_VEM) {
          cat("Saving result ...\n")
      ...
      {
        realization_comparison_dirname = paste0(local_subdirname,"/Realization_comparison_",bij_insert)
      ...
      if (best_keep && (j_select == 1) && testdata && (nb_topics == true_nb_topics))
      {
        ...
        while (nb_topics_assigned < nb_topics)
        {
          ...
          if (!any(k_vect == k) && !any(k1_vect == k1))
          {
            True_topic_correspondence_samplewise[k] = k1
            nb_topics_assigned = nb_topics_assigned + 1
            k_vect[nb_topics_assigned] = k
            k1_vect[nb_topics_assigned] = k1
          }
        ...
        true_KL_documents[true_KL_documents==0] = true_KL_documents_baseline
        
        #True_topic_correspondence_samplewise = vector(length=nb_topics,mode="numeric")
        Mean_KL_samplewise_topic_comparison_true_documents_randomized = vector(length=nb_topics,mode="numeric")
        p_value_true_documents = vector(length = nb_topics, mode = "numeric")
        KL_samplewise_topic_comparison_true_documents = vector(length = nb_topics, mode="numeric")
        DKL100_samplewise_true_documents = vector(length = nb_topics, mode="numeric")
        for (k in 1:nb_topics)
        {
          #True_topic_correspondence_samplewise[k] = which(Best_true_topic_comparison_samplewise[k] == Correlation_true_documents[k,])
          KL_samplewise_topic_comparison_true_documents[k] = 1/2*(KL.plugin(KL_documents_allreal[[1]][,k],true_KL_documents[,True_topic_correspondence_samplewise[k]]) +
                                                                    KL.plugin(true_KL_documents[,True_topic_correspondence_samplewise[k]],KL_documents_allreal[[1]][,k])) 
          nb_non_significant_rndzations = 0
          for (rndzation in 1:nb_rndzations_true_documents) 
          {
            KL_samplewise_topic_comparison_true_documents_randomized = 1/2*(KL.plugin(KL_documents_jselect_randomized[[rndzation]][,k],true_KL_documents[,True_topic_correspondence_samplewise[k]]) +
                                                                              KL.plugin(true_KL_documents[,True_topic_correspondence_samplewise[k]],KL_documents_jselect_randomized[[rndzation]][,k]))
            if (KL_samplewise_topic_comparison_true_documents[k] > KL_samplewise_topic_comparison_true_documents_randomized)
              nb_non_significant_rndzations = nb_non_significant_rndzations + 1
            Mean_KL_samplewise_topic_comparison_true_documents_randomized[k] = 1/nb_rndzations_true_documents*KL_samplewise_topic_comparison_true_documents_randomized + Mean_KL_samplewise_topic_comparison_true_documents_randomized[k]
          }
          p_value_true_documents[k] = nb_non_significant_rndzations/nb_rndzations_true_documents
          DKL100_samplewise_true_documents[k] = (Mean_KL_samplewise_topic_comparison_true_documents_randomized[k] - KL_samplewise_topic_comparison_true_documents[k])
        }
      }
      ...
      if (best_keep && (j_select == 1) && data_pp && !testdata && abiotic_variables)
      {
        ...
        for (k in 1:nb_topics)
        {
          ...
          for (j in 1:length(colnames(data_lidarm)))
          {
            write(paste0("\n",colnames(data_lidarm)[j],"\n%%%%%%%%%%%%%"),file=Abiotic_file,append=T)
      ...
      if ((Rtopicmodels_VEM || (Rtopicmodels_Gibbs && llh_keep)) && (j_select==1))
      {
        plotname = paste("Loglikelihood_convergence_",alpha_insert,"_delta",delta,"_nb_topics",nb_topics,"_nb_real",nb_real,"_nb_iter",nb_iter,".pdf",sep="")
        pdf(plotname)
        #par(mar=c(5.1,4.1,4.1,2.1))
        par(mar=c(5.1,5.1,4.1,2.1))
        ...
        {
          plotname = paste("Loglikelihood_convergence_zoom_",alpha_insert,"_delta",delta,"_nb_topics",nb_topics,"_nb_real",nb_real,"_nb_iter",nb_iter,".pdf",sep="")
          pdf(plotname)
          #par(mar=c(5.1,4.1,4.1,2.1))
          par(mar=c(5.1,5.1,4.1,2.1))
...
if (select_real && realization_comparison)
{
  ...
  save(Correlation_samplewise,Correlation_MOTUwise,KL_samplewise,DKL100_samplewise,file=paste0("Topic_KL-correlation_between_best_real_and_following_reals_",bij_insert,".Rdata"))
  save(Correlation_samplewise_allRealPairs,Correlation_MOTUwise_allRealPairs,KL_samplewise_allRealPairs_w_rndzations,DKL100_samplewise_allRealPairs,llh_differences_allRealPairs,p_value_allRealPairs,file=paste0("Topic_KL-correlation_matrices_between_all_real_",bij_insert,".Rdata"))
  save(Correlation_samplewise_allRealPairs_byTopic,Correlation_MOTUwise_allRealPairs_byTopic,KL_samplewise_allRealPairs_byTopic,DKL100_samplewise_allRealPairs_byTopic,Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic,
       p_value_allRealPairs_byTopic,Topic_correspondence_samplewise_to_best_real,file=paste0("Topic_KL-correlation_matrices_between_all_real_by_topic_",bij_insert,".Rdata"))
  
  Stability_file = paste0("Stability_",bij_insert,".txt")
  
  write(paste(barcode_insert,"-",nb_topics,"topics -",length_selected_real,"realizations\n%%%%%%%%%%%%%\n"),file=Stability_file,append=F)
  write(paste("For all topics :\n%%%%%%%%%%%%%\n"),file=Stability_file,append=T)
  write(paste("Mean samplewise KL distance =",mean(KL_samplewise_allRealPairs[which(!is.na(KL_samplewise_allRealPairs))]),"\n"),file=Stability_file,append=T)
  write(paste("Mean randomized samplewise KL distance for",nb_rndzations,"randomizations per topic =",mean(KL_samplewise_allRealPairs_w_rndzations[lower.tri(KL_samplewise_allRealPairs_w_rndzations,diag=F)]),"\n"),file=Stability_file,append=T)
  write(paste("Mean samplewise KL distance difference for",nb_rndzations,"randomizations per topic =",mean(DKL100_samplewise_allRealPairs[which(!is.na(DKL100_samplewise_allRealPairs))]),"\n"),file=Stability_file,append=T)
  
  SES_denominator = sqrt(mean(Var_KL_samplewise_topic_comparison_randomized_allRealPairs[which(!is.na(Var_KL_samplewise_topic_comparison_randomized_allRealPairs))]) -
                           mean(KL_samplewise_allRealPairs[which(!is.na(KL_samplewise_allRealPairs))])^2)
  SES = mean(DKL100_samplewise_allRealPairs[which(!is.na(DKL100_samplewise_allRealPairs))])/SES_denominator
  write(paste("Mean standardized samplewise KL distance difference (SES) for",nb_rndzations,"randomizations per topic =",SES,"\n"),file=Stability_file,append=T)
  ...
  write(paste("Mean samplewise correlation =",mean(Correlation_samplewise_allRealPairs[which(Correlation_samplewise_allRealPairs!=0)]),"\n"),file=Stability_file,append=T)
  write(paste("Mean MOTUwise correlation =",mean(Correlation_MOTUwise_allRealPairs[which(Correlation_MOTUwise_allRealPairs!=0)]),"\n"),file=Stability_file,append=T)
  ...
  for (k in 1:nb_topics)
  {
    ...
    mean_correlation = 0
    mean_correlation_MOTUwise = 0
    for (j_real in 1:(length_selected_real-1))
    {
      p_value = sum(p_value_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + p_value
      mean_KL = sum(KL_samplewise_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + mean_KL
      mean_DKL100 = sum(DKL100_samplewise_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + mean_DKL100
      mean_SES_denominator = sum(Var_KL_samplewise_topic_comparison_randomized_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + mean_SES_denominator
      mean_correlation = sum(Correlation_samplewise_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + mean_correlation
      mean_correlation_MOTUwise = sum(Correlation_MOTUwise_allRealPairs_byTopic[[Topic_correspondence_samplewise_to_best_real[[j_real]][k0]]][j_real,-(1:j_real)])/((length_selected_real-1)*length_selected_real/2) + mean_correlation_MOTUwise
    }
    mean_SES_denominator = sqrt(mean_SES_denominator - mean_KL^2)
    SES = mean_DKL100/mean_SES_denominator
    write(paste("For topic",k,":\n%%%%%%%%%%%%%\n"),file=Stability_file,append=T)
    write(paste("Mean samplewise KL distance =",mean_KL,"\n"),file=Stability_file,append=T)
    write(paste("Mean samplewise KL distance difference for",nb_rndzations,"randomizations per topic =",mean_DKL100,"\n"),file=Stability_file,append=T)
    write(paste("Mean standardized samplewise KL distance difference (SES) for",nb_rndzations,"randomizations per topic =",SES,"\n"),file=Stability_file,append=T)
    write(paste("Mean p-value for",nb_rndzations,"randomizations per topic =",p_value,"\n"),file=Stability_file,append=T)
    write(paste("Mean samplewise correlation =",mean_correlation,"\n"),file=Stability_file,append=T)
    write(paste("Mean MOTUwise correlation =",mean_correlation_MOTUwise,"\n"),file=Stability_file,append=T)
  }
  
  pdf("Topic_KL_distance_samplewise_between_real_color2D.pdf")
  # 2 topics :
  #par(mfrow=c(2,1))
  # 5 topics :
  #par(mfrow=c(3,2))
  ...
  pdf("Topic_correlation_samplewise_between_real_color2D.pdf")
  # 2 topics :
  #par(mfrow=c(2,1))
  # 5 topics :
  #par(mfrow=c(3,2))
  ...
  for (j_select in 2:length_selected_real)
  {
    ...
    # red-grey-blue divergence_hcl(3) color scale: c(142/255,226/255,2/255),c(6/255,226/255,63/255),c(59/255,226/255,165/255)
    color2D.matplot(Correlation_samplewise[[j_select-1]],c(0,1),c(0,0),c(1,0),xrange=c(-1,1),
                    extremes=NA,cellcolors=NA,show.legend=TRUE,nslices=10,xlab=paste("Topics in the ",Selected_real[j_select],tag," best realization",sep=""),
                    ylab="Topics in the best realization",do.hex=FALSE,axes=TRUE,show.values=FALSE,vcol="white",vcex=1,
                    border="black",na.color="white",main=paste(Selected_real[j_select],tag," best realization",sep=""))
  }
  ...
  #par(mar=c(5.1,4.1,4.1,2.1)
  par(mar=c(5.1,5.1,4.1,2.1))
  color2D.matplot(KL_samplewise_allRealPairs,c(0,1),c(0,0),c(1,0),
  ...
  {
    pdf("p-value_matrix_based_on_KL_samplewise_color2D.pdf")
    #par(mar=c(5.1,4.1,4.1,2.1)
    par(mar=c(5.1,5.1,4.1,2.1))
  ...
  pdf("KL_distance_matrix_samplewise_randomized_and_non-randomized_color2D.pdf")
  # 2 topics :
  #par(mfrow=c(2,1))
  # 5 topics :
  #par(mfrow=c(3,2))
  ...
  #par(mar=c(5.1,4.1,4.1,2.1)
  par(mar=c(5.1,5.1,4.1,2.1))
  color2D.matplot(KL_samplewise_allRealPairs_w_rndzations,c(0,1),c(0,0),c(1,0),
                  extremes=NA,cellcolors=NA,show.legend=TRUE,nslices=10,xlab=paste("Realizations ranked by decreasing likelihood",sep=""),
                  ylab="Realizations ranked by decreasing likelihood",do.hex=FALSE,axes=TRUE,show.values=FALSE,vcol="white",vcex=1,
                  border="black",na.color="white")
  dev.off()
  ...
  pdf("Correlation_matrix_samplewise_color2D.pdf")
  # 2 topics :
  #par(mfrow=c(2,1))
  # 5 topics :
  #par(mfrow=c(3,2))
  ...
  color2D.matplot(Correlation_samplewise_allRealPairs[-nrow(Correlation_samplewise_allRealPairs),-1],c(0,1),c(0,0),c(1,0),
                  extremes=NA,cellcolors=NA,show.legend=TRUE,nslices=10,xlab=paste("Realizations ranked by decreasing likelihood",sep=""),
                  ylab="Realizations ranked by decreasing likelihood",do.hex=FALSE,axes=TRUE,show.values=FALSE,vcol="white",vcex=1,
                  border="black",na.color="white")
  dev.off()
  
  pdf("Topic_KL_samplewise_between_all_real_pairs.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  ...
  plot(llh_differences_allRealPairs[llh_differences_allRealPairs>0],KL_samplewise_allRealPairs[!is.na(KL_samplewise_allRealPairs)],type="p", main = "Averaged samplewise KL distance between\n pairs of realizations",
       xlab = "Loglikelihood difference", ylab = "KL distance samplewise")
  dev.off()
  
  pdf("Topic_KL_difference_samplewise_between_all_real_pairs_w_randomizations.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  par(mar = c(5, 5, 4, 3) + 0.1)
  #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
  #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")  
  if (length(which(!is.na(DKL100_samplewise_allRealPairs))) != length(which(llh_differences_allRealPairs>0)))
    cat("\nError in DKL100_samplewise_allRealPairs values")
  plot(llh_differences_allRealPairs[llh_differences_allRealPairs>0],DKL100_samplewise_allRealPairs[!is.na(DKL100_samplewise_allRealPairs)],type="p", main = "Averaged samplewise KL distance difference between\n pairs of realizations",
       xlab = "Loglikelihood difference", ylab = "Difference of KL distance samplewise")
  dev.off()
  ...
  pdf("Topic_KL_samplewise_between_real_averaged_vs_llh_difference.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  par(mar = c(5, 5, 4, 3) + 0.1)
  #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
  #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")
  plot(Ordered_realizations$x[1]-Ordered_realizations$x[2:length_selected_real],KL_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise KL distance between\n the component communities in different realizations",
       xlab = "Loglikelihood difference with best realization", ylab = "KL distance to best realization samplewise")
  dev.off()
  
  pdf("Topic_KL_samplewise_between_real_averaged_topic_by_topic_vs_llh_difference.pdf")  
  par(mfrow=c(2,2))
  for (k in 1:nb_topics)
  {
    par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
    ...
    #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
    #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")   
    plot(Ordered_realizations$x[1]-Ordered_realizations$x[2:length_selected_real],KL_samplewise_allRealPairs_byTopic[[rev(sort_normal_topic_allreal[[1]]$ix)[k]]][1,-1],
         type="p", main = paste("Averaged samplewise KL distance\n assemblage", k),
         xlab = "Loglikelihood difference\n with best realization", ylab = "KL distance\n to best realization samplewise")
  }
  dev.off()
  
  pdf("Topic_KL_samplewise_between_real_averaged_topic_by_topic_vs_rank.pdf")  
  par(mfrow=c(2,2))
  for (k in 1:nb_topics)
  {
    par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
    ...
    #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
    #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")   
    plot(seq(2,length_selected_real,1),KL_samplewise_allRealPairs_byTopic[[rev(sort_normal_topic_allreal[[1]]$ix)[k]]][1,-1],
         type="p", main = paste("Averaged samplewise KL distance\n assemblage", k),
         xlab = "Realizations sorted\n by decreasing llh", ylab = "KL distance\n to best realization samplewise")
  }
  dev.off()
  
  pdf("Topic_KL_samplewise_between_real_averaged_vs_rank.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  par(mar = c(5, 5, 4, 3) + 0.1)
  #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
  #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")
  plot(seq(2,length_selected_real,1),KL_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise KL distance between\n the component communities in different realizations",
       xlab = "Realizations sorted by decreasing llh", ylab = "KL distance to best realization samplewise")
  dev.off()
  ...
  pdf("Topic_KL_difference_samplewise_between_real_averaged_vs_p-value.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  par(mar = c(5, 5, 4, 3) + 0.1)
  plot(p_value_allRealPairs[1,-1],DKL100_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise KL distance diffrence between\n the component communities in different realizations",
       xlab = "p-value", ylab = "Difference in KL distance to best realization samplewise", xlim=range(p_value_allRealPairs[1,-1]))
  dev.off()
  
  pdf("Topic_KL_difference_samplewise_between_real_averaged_w_randomizations_vs_rank.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  # par(mar = c(bottom, left, top, right))
  par(mar = c(5, 5, 4, 3) + 0.1)
  #     plot(seq(2,length_selected_real,1),apply(Topic_comparison,1,mean),ylim=c(0,1),type="p", main = "Averaged Hellinger similarity between\n the component communities in different realizations",
  #          xlab = "Realizations ranked by decreasing likelihood", ylab = "Hellinger similarity")
  plot(seq(2,length_selected_real,1),DKL100_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise KL distance difference between\n the component communities in different realizations",
       xlab = "Realizations sorted by decreasing llh", ylab = "Difference in KL distance to best realization samplewise")
  dev.off()
  ...
  pdf("Topic_correlation_samplewise_between_real_averaged.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  plot(Ordered_realizations$x[1]-Ordered_realizations$x[2:length_selected_real],Correlation_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise correlation between\n the component communities in different realizations",
       xlab = "Loglikelihood difference with best realization", ylab = "Correlation coefficient with best realization")
  dev.off()
  
  pdf("Topic_correlation_samplewise_between_real_averaged_vs_rank.pdf")  
  par(cex.lab=1.5,cex.main=1.7,cex.axis=1.5,lwd=2)
  plot(seq(2,length_selected_real,1),Correlation_samplewise_allRealPairs[1,-1],type="p", main = "Averaged samplewise correlation between\n the component communities in different realizations",
...
if (testdata)
{
  if (realization_comparison)
  {
    ...
    for (k in 1:nb_topics)
    {
      ...
      for (j_select in 2:length_selected_real)
      {
        index0 = which(Correlation[[j_select-1]][k,] == max(Correlation[[j_select-1]][k,]))
    ...
    for (k in 1:nb_topics)
    {
      ...
      for (j_select in 2:length_selected_real)
      {
        index1 = which(Correlation[[j_select-1]][k,] == max(Correlation[[j_select-1]][k,]))
  ...
  if (nb_topics == true_nb_topics)
  {
    ...
    for (k in 1:nb_topics)
      write(KL_samplewise_topic_comparison_true_documents[k],file=KL_true_topics_file,append=T)
    write(paste("Mean =",mean(KL_samplewise_topic_comparison_true_documents)),file=KL_true_topics_file,append=T)
    ...
    for (k in 1:nb_topics)
      write(Mean_KL_samplewise_topic_comparison_true_documents_randomized[k],file=KL_true_topics_file,append=T)
    write(paste("Mean =",mean(Mean_KL_samplewise_topic_comparison_true_documents_randomized)),file=KL_true_topics_file,append=T)
    ...
    for (k in 1:nb_topics)
      write(DKL100_samplewise_true_documents[k],file=KL_true_topics_file,append=T)
    write(paste("Mean =",mean(DKL100_samplewise_true_documents)),file=KL_true_topics_file,append=T)
...
} else if (mpar)
{
  ...
  if (mnb_topics)
  {
    ...
    {
      if (Rtopicmodels_Gibbs) {
        save(Result_mpar,LLH_final0,AIC0,nb_topics_range,alpha_insert,delta,nb_real,nb_iter,file=filename)
      } else if (Rtopicmodels_VEM)  {
        save(Result_mpar,LLH_final0,AIC0,nb_topics_range,alpha_insert,nb_real,alpha_est0,file=filename)
      }
    }
    ########
