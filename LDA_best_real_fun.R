...
LDA_best_real_fun <- function(nb_rndzations_best_real,nrow_data2m,sort_normal_topic,KL_documents,KL_topic_compo,assemblage_names_vect,documents,topic_compo,sum_data2m){
